...
<html>
	<head>
		...
		<title>刮刮卡</title>
		<link href="<?=base_url().'css/activity-style.css'?>" rel="stylesheet" type="text/css">
	</head>
	...
	<body data-role="page" class="activity-scratch-card-winning">
		...
		<script src="<?=base_url().'js/wScratchPad.js'?>" type="text/javascript"></script>
		<div class="main">
			<div class="cover">
				<img src="<?=base_url().'images/activity-scratch-card-bannerbg.png'?>">
				<div id="prize">
				</div>
				<div id="scratchpad">
				</div>
